...
// class $modify(BatchNodeHook, CCSpriteBatchNode) {
//     void visit() {
...
//             if (!child) {
//                 log::error("Null child in CCSpriteBatchNode children!");
//                 log::error("This: {}", this);
//                 for (auto c : CCArrayExt<CCSprite>(m_pChildren)) {
//                     log::error(" - Child: {}", c);
//                 }
//                 __debugbreak();
//             }
